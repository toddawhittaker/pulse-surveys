 ...
 *
 * `csrf_verified_student` and its siblings (`app.api.deps`) require the header
 * from any request whose session rides the cookie, and exempt the Bearer
 * carrier — a Bearer header is not something a cross-site form can be tricked
