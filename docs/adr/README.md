...
| [0044](0044-a-supervision-edge-must-climb-the-role-rank.md) | A supervision edge must climb the role rank, and the trigger is what refuses one that does not | Accepted — extends [0027](0027-supervision-edges-are-policed-by-one-row-level-trigger.md); settles the choice E0-09 left in neither place; bounds the graph at six deep and subsumes acyclicity, and the equal-rank half is in dispute ([E0-11-01](../disputes/E0-11-01.md)) |
