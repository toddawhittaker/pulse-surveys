...
| [0065](0065-the-demo-institution-registers-a-fictional-platform.md) | The demo institution registers a fictional platform, and not the mock LMS | Accepted — leaves [0038](0038-the-mock-platform-ships-in-the-base-compose-file.md) standing unamended, which is the point; E0-18 still needs a registration for the mock and does not get one here |
