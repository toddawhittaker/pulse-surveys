...
| 07 | [The mock platform mints deliberately wrong launches](E1-07-mock-wrong-launches.md) | `e1/mock-wrong-launches` | none | Bad signature, wrong audience, replayed nonce, tampered state, stale timestamps, and the title-less context — the fixtures E1's negative tests need and E0 never built. |
