...
| 16 | [The survey schema's migrations survive a round trip, and the sweep survives a term](E2-16-data-model-repairs.md) | `e2/data-model-repairs` | 14, 15 | The always-run boundary agents' verified data-model findings: two irreversible migrations repaired, the response term rule, the sweep's query shape, batched derivation; carries the round's docs bundle. | #156 as 132b92e, 2026-09-03 |
| 17 | [The survey form works for every student who can open it](E2-17-student-surface-repairs.md) | `e2/student-surface-repairs` | 14, 15 | The a11y and CSRF findings: the never-disabled submit, programmatic polarity, contrast tokens, announced required flip, course labels on the wire, the confidentiality sentence once per screen. | #157 as 0633f4a, 2026-09-03 |
| 18 | [Three pins the eval gate's own review asked for](E2-18-eval-guard-pins.md) | `e2/eval-guard-pins` | 12 | Prompt files pinned by content, the eval routing pinned against the submit path, the case set's composition pinned whole. | #155 as 6876a6d, 2026-09-03 |
