...
|---|---|---|---|---|---|---|
| 01 | [The comparison-set schema](E5-01-comparison-set-schema.md) | `e5/comparison-set-schema` | heavy | none | The `comparison_set` model (decision 3): named sets as member courses plus one declared length+level pair, constraints making invalid combinations unstorable, grants, migration. | |
